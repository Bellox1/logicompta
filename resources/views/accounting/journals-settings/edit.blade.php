    ...
    <div class="mb-10 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Modifier le Journal</h1>
            </div>
            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Modification de l'entité : {{ $journal->name }}</p>
        </div>
    </div>
