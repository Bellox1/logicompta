            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" placeholder="Ex: Opérations en espèces uniquement..." rows="4"
                        class="w-full bg-white border border-border px-6 py-4 text-sm font-bold outline-none focus:border-primary transition-all rounded-xl shadow-sm resize-y">{{ old('description') }}</textarea>
                </div>
            </div>
