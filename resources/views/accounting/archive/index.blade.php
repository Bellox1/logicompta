...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-800">Archives des Exercices</h1>
    <p class="text-gray-500">Consultez l'historique de vos journaux, bilans et balances archivés par année.</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="p-6">
                ...
                <a href="{{ route('accounting.archive.show', $data->year) }}" 
                   class="flex items-center justify-center gap-2 w-full py-3 bg-gray-50 hover:bg-primary hover:text-white text-gray-800 font-bold rounded-lg transition-all text-sm border border-gray-100 hover:border-primary">
    ...
    @empty
        <div class="col-span-full bg-gray-50 border border-gray-100 rounded-none p-16 text-center shadow-inner">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-white rounded-full shadow-sm mb-6 border border-gray-100">
                <i data-lucide="archive" class="w-10 h-10 text-primary opacity-40"></i>
            </div>
            <h2 class="text-xl font-black text-gray-800 mb-2 uppercase tracking-tight">Aucune archive disponible</h2>
            <p class="text-gray-400 max-w-sm mx-auto text-sm font-medium">
