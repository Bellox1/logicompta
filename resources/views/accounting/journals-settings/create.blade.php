...
@section('content')
    <div class="max-w-800 mx-auto" style="max-width: 800px;">
        <div class="mb-5 d-flex align-items-center">
            ...
            <div>
                <h1 class="h3 font-weight-bold text-dark mb-1" style="font-family: 'Manrope';">Nouveau Journal</h1>
                <p class="text-muted small font-weight-bold uppercase tracking-wider">Configurez un support pour vos écritures comptables</p>
            </div>
        </div>
        ...
        <div class="premium-card">
            <form action="{{ route('accounting.journals-settings.store') }}" method="POST">
                @csrf
                <div class="form-group mb-4">
                    <label class="form-label-premium">Nom du journal</label>
                    <input type="text" name="name" value="{{ old('name', 'Journal de ') }}" placeholder="Ex: Journal de Caisse" class="form-control form-control-premium" required>
                </div>

                <div class="form-group mb-5">
                    <label class="form-label-premium">Description (Optionnel)</label>
                    <textarea name="description" placeholder="Ex: Opérations en espèces uniquement..." rows="4" class="form-control textarea-premium">{{ old('description') }}</textarea>
                </div>
