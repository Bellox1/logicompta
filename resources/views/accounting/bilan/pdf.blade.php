...
<head>
    ...
    <style>
        ...
        .total-row { background: #eee; font-weight: bold; font-family: sans-serif; }
    </style>
</head>
<body class="bg-white p-4 md:p-8">
    ...
    <div class="mb-8 border-b-2 border-gray-900 pb-6 flex flex-col md:flex-row md:justify-between md:items-end gap-6">
        <div>
            <h1 class="text-3xl font-black uppercase tracking-tighter text-gray-900">BILAN COMPTABLE GÉNÉRAL</h1>
    ...
    <div class="flex flex-col xl:flex-row gap-6 mt-4">
        <!-- ACTIF -->
        <div class="flex-1 overflow-x-auto shadow-sm rounded-xl border border-gray-200">
            <table class="w-full min-w-[500px]">
            <thead>
                <tr><th colspan="2" class="text-lg py-3">ACTIF (IMMOBILISATIONS & DISPONIBILITÉS)</th></tr>
        ...
        <!-- PASSIF -->
        <div class="flex-1 overflow-x-auto shadow-sm rounded-xl border border-gray-200 mt-6 xl:mt-0">
            <table class="w-full min-w-[500px]">
            <thead>
                <tr><th colspan="2" class="text-lg py-3">PASSIF (CAPITAUX PROPRES & DETTES)</th></tr>
